...
from PyQt5.QtWidgets import QProgressBar, QStyle, QFileDialog, QMessageBox
...
class WidgetRun(QWidget):
    ...
    def createOutputDir(self, dirPath, simName):
        ...
        If the parent directory path is not given (blank), the parent directory will be taken as
        the base directory of the GUI file.
        ...
        if Path(dirPath).is_dir() or dirPath == "":
            ...
            if not Path(outputPath / "params.txt").exists():
                ...
                errMsgs.append("The selected simulation directory has already been used to run a simulation." +
    ...
    def updateProg(self, progValue, maxT, numRuns):
        ...
        if curRun <= numRuns:
            if progValue % (maxT + 1) == 0:
                ...
                self.msgBar.setText("Running simulation {} run {}/{} day {}/{}".format(self.simName,
                                                                                       curRun, numRuns,
                                                                                       curDay, maxT))
