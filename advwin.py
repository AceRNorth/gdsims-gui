...
class AdvancedWindow(QDialog):
    ...
    def createGridLayout(self):
        ...
        setLabelLabel = QLabel("simulation label \U0001F6C8")
        ...
        recIntervalLocalLabel = QLabel("output frequency (full data) \U0001F6C8")
        recIntervalLocalLabel.setToolTip("Time interval at which to collect/record local data (in days).\nA low value produces higher temporal resolution data, though will result in larger output file sizes.")
        ...
        muJLabel = QLabel("juvenile mortality rate \U0001F6C8")
        ...
        muALabel = QLabel("adult mortality rate \U0001F6C8")
        ...
        betaLabel = QLabel("mating rate factor \U0001F6C8")
        betaLabel.setToolTip("Number of males in a patch when local females mate with probability ½ per day.")
        ...
        thetaLabel = QLabel("egg laying rate \U0001F6C8")
        ...
        compPowerLabel = QLabel("juvenile survival factor \U0001F6C8")
        ...
        minDevLabel = QLabel("juvenile min. development time \U0001F6C8")
        ...
        dispRateLabel = QLabel("dispersal rate \U0001F6C8")
        ...
        maxDispLabel = QLabel("max. dispersal distance \U0001F6C8")
        ...
        psiLabel = QLabel("aestivation rate \U0001F6C8")
        ...
        muAesLabel = QLabel("aestivation mortality \U0001F6C8")
        ...
        tHide1Label = QLabel("start hiding date \U0001F6C8")
        ...
        tHide2Label = QLabel("end hiding date \U0001F6C8")
        ...
        tWake1Label = QLabel("start waking date \U0001F6C8")
        ...
        tWake2Label = QLabel("end waking date \U0001F6C8")
        ...
        alpha0MeanLabel = QLabel("population size factor \U0001F6C8")
        ...
        alpha0VarLabel = QLabel("population size variance \U0001F6C8")
        ...
        alpha1Label = QLabel("rainfall contribution\nto population size \U0001F6C8")
        ...
        ampLabel = QLabel("rainfall seasonality \U0001F6C8")
        ...
        respLabel = QLabel("responsiveness to rainfall \U0001F6C8")
        ...
        gammaLabel = QLabel("resistance formation rate \U0001F6C8")
